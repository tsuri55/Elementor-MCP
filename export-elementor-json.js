// Export Elementor JSON to file for manual import
const fs = require('fs');
const path = require('path');

// Import the buildElementorData function from create-landing-page.js
...
console.log("Exporting Elementor JSON...");

const elementorData = buildElementorData();
const outputPath = path.join(__dirname, 'cloudstore-landing-elementor.json');
...
console.log("2. Create a new page or edit an existing one");
console.log("3. Click 'Edit with Elementor'");
console.log("4. In Elementor, click the folder icon (☰) → Templates");
console.log("5. Go to 'Saved Templates' → 'Import Templates'");
console.log("6. Upload the JSON file and insert it into your page");
console.log("\nDone! 🎉");
